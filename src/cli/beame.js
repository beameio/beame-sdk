...
var parametersSchema = {
	...
	'atomType':       {required: true, options: ['Default','AuthorizationAgent','AuthorizationServer']},
	...
	'file':           {required: false},
	'pk':             {required: true},
	'requiredLevel':  {required: false, options: ['Default','AuthorizationAgent','AuthorizationServer']},
