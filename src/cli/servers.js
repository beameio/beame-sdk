 ...
 * @param {String} fqdn
 */
function runSampleChat(fqdn) {
	beameSDK.BaseHttpsServer.SampleBeameServer(fqdn,  appExpress, function (data, app) {
...
function launchHelloWorldServer(edgeClientFqdn) {
	...
	new BeameServer(edgeClientFqdn,  null, function (data, app) {
